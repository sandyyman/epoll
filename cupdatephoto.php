...
include 'config.php';
    ...
    if(isset($_POST['update'])){
        ...
        $sql="UPDATE candidate SET cphoto ='$filename' where cid='$cid'";
...
<html lang="en">
  <head>
    ...
    <title>Candidate Photo Update</title>
      ...
      <div class="row">
        ...
        <center>
          <div class="page-header">           
            <form action="cupdatephoto.php" method="POST" enctype="multipart/form-data">
